...
if __name__ == '__main__':
    ...
    run_experiment_script(params="xgb_es.yml", save_results="exp3_1.csv", num_searches=40, n_fold=10)
    run_experiment_script(params="cat_es.yml", save_results="exp3_1.csv", num_searches=40, n_fold=10)
